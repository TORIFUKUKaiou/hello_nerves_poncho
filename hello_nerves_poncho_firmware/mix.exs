defmodule HelloNervesPonchoFirmware.MixProject do
  use Mix.Project

  @app :hello_nerves_poncho_firmware
  @version "0.1.0"
  ...
  def application do
    [
      mod: {HelloNervesPonchoFirmware.Application, []},
  ...
  defp deps do
    [
      ...
      {:hello_nerves_poncho_slack_bandit,
       path: "../hello_nerves_poncho_slack_bandit", targets: @all_targets, env: Mix.env()}
    ]
  end
